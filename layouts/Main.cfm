...
<head>
	...
	<link href="#mixPath( "client.css" )#" rel="stylesheet">
	<!---js --->
...
<body data-spy="scroll">
	...
	<script src="#mixPath( "manifest.js" )#"></script>
	<script src="#mixPath( "vendor.js" )#"></script>
	<script src="#mixPath( "client.js" )#"></script>
</body>
</html>
</cfoutput>
